...
function initProject(args) {
  ...
  console.log("  npx localbase start");
  console.log("  npx localbase agent codex");
}
...
This directory was generated by \`npx localbase init\`.
...
function printCodexConfig() {
  ...
  console.log("");
  console.log(`codex mcp add localbase --env API_BASE_URL=${apiUrl} -- npx localbase mcp --project ${projectArg}`);
  console.log("");
  console.log("Manual config:");
  console.log("");
  console.log("[mcp_servers.localbase]");
  console.log('command = "npx"');
  console.log(`args = ["localbase", "mcp", "--project", ${JSON.stringify(projectDir)}]`);
  console.log("");
...
function ensureProject(projectDir = process.cwd()) {
  if (!existsSync(resolve(projectDir, "docker-compose.yml")) || !existsSync(resolve(projectDir, "localbase.config.json"))) {
    exitWith("This command must be run from a Localbase project directory. Create one with: npx localbase init");
  }
}
